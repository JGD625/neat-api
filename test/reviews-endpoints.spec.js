...
describe.only('Reviews Endpoints', function() {
  ...
  describe(`POST /api/reviews`, () => {
    ...
    it(`creates an review, responding with 201 and the new review`, function() {
      this.retries(3)
      const testLiquor = testThings[0]
      const testUser = testUsers[0]
      const newReview = {
        text: 'Test new review',
        rating: 3,
        thing_id: testLiquor.id,
      ...
      return supertest(app)
        ...
        .expect(res => {
          ...
          expect(res.body.thing_id).to.eql(newReview.liquor_id)
        ...
        .expect(res =>
          db
            ...
            .then(row => {
              ...
              expect(row.liquor_id).to.eql(newReview.liquor_id)
